...
static void		vm_and_5(t_vm *vm, t_cmd *cmd, int *arg)
{
...
static void		vm_and_4(t_vm *vm, t_cmd *cmd, int *arg)
{
...
static void		vm_and_3(t_vm *vm, t_cmd *cmd, int *arg)
{
...
static void		vm_and_2(t_vm *vm, t_cmd *cmd, int *arg)
{
