...
static void		vm_xor_5(t_vm *vm, t_cmd *cmd, int *arg)
{
...
static void		vm_xor_4(t_vm *vm, t_cmd *cmd, int *arg)
{
...
static void		vm_xor_3(t_vm *vm, t_cmd *cmd, int *arg)
{
...
static void		vm_xor_2(t_vm *vm, t_cmd *cmd, int *arg)
{
